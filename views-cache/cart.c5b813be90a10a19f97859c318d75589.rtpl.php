                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="text" placeholder="Digite o cupom"  value="" id="cupom" class="input-text" name="cupom">
                                        <input type="submit" formmethod="post" formaction="/cart/cupom" value="CÁLCULAR" class="button">
                                    </div>
